...
3. Spawn `news-feed-curator` subagents to USE fetch news feed following `about-me/sources.md` in parallel and DO NOT fetch full content on this step.
4. Spawn `news-curator` subagents to fetch the content from page URLs and summarize stories following the interested list we've got.
5. Summarize all the stories in `/daily-news/news-{DD-MM-YYYY}.md`
